...
class productosSeeder extends Seeder
{
    ...
    public function run()
    {
        Producto::create([
            'nombre'=>'Rimmel',
            'descripcionBreve'=>'Rimmel lash',
            'descripcionGrande'=>'Rimmel lash sensational de maybeline',
            'precio'=>12,
            'stock'=>5,
        ...
        Producto::create([
            'nombre'=>'Eyerline',
            'descripcionBreve'=>'Eyerline essence',
            'descripcionGrande'=>'Eyerline essence waterproof',
            'precio'=>6,
            'stock'=>8,
        ...
        Producto::create([
            'nombre'=>'Base LOreal',
            'descripcionBreve'=>'Base de maquillaje',
            'descripcionGrande'=>'Base de maquillaje LOreal',
            'precio'=>16,
            'stock'=>10,
        ...
        Producto::create([
            'nombre'=>'Sérum Facial',
            'descripcionBreve'=>'Sérum facial',
            'descripcionGrande'=>'Sérum facial Ordinary con ácido hialurónico',
            'precio'=>12,
            'stock'=>3,
        ...
        Producto::create([
            ...
            'descripcionBreve'=>'Pintalabios Morado',
            'descripcionGrande'=>'Pintalabios Morado  Maybeline SuperStay',
            'precio'=>12.99,
            'stock'=>8,

        ...
        <div class="col-sm-3 mb-5 border-0" >
            <div class="card border-0" style=" width:200px; " >
                ...
                <div class="card-body text-center m-0 p-0" style="max-height: 150px;">
                    <h5 class="card-title m-0 p-0">@lang('messages.Producto'): {{ $producto->nombre }}</h5>
                    <p class="card-text m-0 p-0">@lang('messages.Descripción'): {{ $producto->descripcion }}</p>
                    <p class="card-text h5 m-0 mb-1 p-0" style="color:#88389c;">@lang('messages.Precio'): {{ $producto->precio }}€</p>

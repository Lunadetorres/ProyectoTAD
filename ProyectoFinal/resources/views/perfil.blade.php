...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-white" style="background-color:#88389c;">{{ __('Modificar') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('usuario.store') }}">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="userId" type="text" class="form-control" name="userId" value="{{ $Usuario->id }}" required autocomplete="userId" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="nombreUsuario" type="text" class="form-control @error('nombreUsuario') is-invalid @enderror" name="nombreUsuario" value="{{ $Usuario->nombreUsuario }}" required autocomplete="nombreUsuario" autofocus>
